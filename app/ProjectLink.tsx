  ...
  return (
    <>
      <Link
        onClick={() => confirm()}
        href={doc.lot}
        className="fade-transition my-2 flex h-[160px] w-full flex-row justify-between rounded-xl border-[1px] border-transparent bg-opacity-50 p-2 active:border-blue-900 active:dark:border-blue-200 md:hover:bg-blue-900 md:hover:bg-opacity-50 md:hover:text-white md:hover:shadow-lg md:hover:dark:bg-blue-200 md:hover:dark:bg-opacity-50 md:hover:dark:text-black"
      >
