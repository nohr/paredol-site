...
export default function HomePage() {
  ...
  const data = useSearch(projects, query);
  // React.useEffect(() => {
  //   projects !== undefined && Packing(svg, projects);
  // }, [svg]);
  ...
  ((data) => {
    ...
    var mousemove = (d) => {
      Tooltip.html("<u>" + d.key + "</u>" + "<br>" + d.value + " inhabitants")
        .style("left", pointer(this)[0] + 20 + "px")
    ...
    function dragstarted(d) {
      if (!pointer.active) simulation.alphaTarget(0.03).restart();
      d.fx = d.x;
      d.fy = d.y;
    }
    function dragged(d) {
    ...
    function dragended(d) {
      if (!pointer.active) simulation.alphaTarget(0.03);
      d.fx = null;
      d.fy = null;
    }
  })(data);
