...
const Options = ({ ...props }) => {
  ...
  return (
    <div
      ref={ref}
      className={`${className} bottom-36 z-50 mx-1 grid w-full grid-cols-[48%_4%_48%] grid-rows-[min-content] items-start rounded-2xl border-t-[1px] border-blue-900 p-3 !backdrop-blur-lg dark:border-blue-200 md:fixed md:top-[68px] md:right-4 md:mx-0 md:h-min md:w-48 md:grid-cols-[100%] md:grid-rows-[min-content_20px_min-content] md:border-y-0 lg:w-60`}
    >
