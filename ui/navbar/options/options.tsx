    ...
    <AnimatePresence>
      {options && (
        <motion.div
          ...
          ref={ref}
          className={`${className} bottom-36 z-50 mx-1 grid w-full items-start border-blue-900 p-3 backdrop-blur-lg dark:border-blue-200 md:fixed md:!top-[54px] md:right-4 md:mx-0 md:h-min md:w-48 md:grid-cols-[100%] md:grid-rows-[min-content_20px_min-content] md:rounded-2xl md:border-[1px] md:bg-white md:bg-opacity-70 md:pt-10 md:shadow-lg md:dark:bg-black md:dark:bg-opacity-70 lg:w-60`}
        >
